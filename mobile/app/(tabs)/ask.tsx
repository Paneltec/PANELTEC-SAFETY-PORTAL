...
const styles = StyleSheet.create({
  ...
  chip: {
    ...
    borderColor: '#DDD6FE', backgroundColor: Colors.violetSoft,
  },
  ...
  deleteConfirmChip: {
    ...
    backgroundColor: '#fbe4e7', borderWidth: 1, borderColor: '#e69aa3', marginRight: 6, marginBottom: 4,
  },
  deleteConfirmText: { fontSize: 10, fontWeight: '600', color: '#7a1f33' },
  ...
  sugForm: {
    ...
    backgroundColor: Colors.white, paddingHorizontal: 6, paddingVertical: 4,
  ...
  catOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.3)', justifyContent: 'center', alignItems: 'center', padding: 24 },
  catBox: { backgroundColor: Colors.white, borderRadius: 16, padding: 16, width: '100%', maxWidth: 260 },
  catTitle: { fontSize: 16, fontWeight: '700', color: Colors.ink, marginBottom: 8 },
  catItem: { paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#F1F5F9' },
