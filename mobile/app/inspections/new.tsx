...
const s = StyleSheet.create({
  ...
  changeLink: { fontSize: 13, color: Colors.orangeLight, fontWeight: '500' },
  ...
  checkItemBorder: { borderTopWidth: 1, borderTopColor: Colors.border },
  ...
  respPass: { borderColor: Colors.emerald, backgroundColor: Colors.mint },
  respFail: { borderColor: Colors.red, backgroundColor: Colors.redSoft },
