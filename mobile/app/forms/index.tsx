...
const s = StyleSheet.create({
  ...
  // v160.0.4 — polished card on dark theme: `surface` is slate-900 so
  // white text pops; slate-700 border reads as elevation instead of an
  // outline on white. Subtle black shadow adds real lift.
  card: {
  ...
  // v160.0.4 — full dark-theme card. On dark navy surface, slate-300
  // text is the readable pair; the previous v160.0.3 fix bumped text
  // darkness assuming a white card, which fought the app's dark chrome.
  ...
  // v160.0.4 — Preview + Fill buttons on dark card: Preview is an
  // outlined orange pill, Fill is solid orange gradient with amber glow.
  previewBtn: {
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6,
    paddingVertical: 12, borderRadius: 12, borderWidth: 2, borderColor: Colors.orange, backgroundColor: Colors.orangeSoft, minHeight: 48,
  },
  previewBtnText: { fontSize: 13, fontWeight: '800', color: Colors.orangeLight, letterSpacing: 0.3 },
  fillBtn: {
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6,
