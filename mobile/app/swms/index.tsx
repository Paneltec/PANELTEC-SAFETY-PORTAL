...
const s = StyleSheet.create({
  ...
  pasteBtnText: { fontSize: 13, fontWeight: '600', color: '#EA580C' },
  scanBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 5,
    paddingHorizontal: 12, paddingVertical: 9,
    borderRadius: 10, borderWidth: 1, borderColor: '#F97316',
  ...
  scanBtnText: { fontSize: 13, fontWeight: '600', color: '#EA580C' },
  addBtn: {
  ...
  cardSelected: { borderColor: '#F97316', backgroundColor: '#FFFBEB' },
