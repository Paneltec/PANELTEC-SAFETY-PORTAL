...
const s = StyleSheet.create({
  ...
  addLink: { fontSize: 14, color: Colors.blue, fontWeight: '500' },
  signRow: { flexDirection: 'row', gap: 6, marginBottom: 6, alignItems: 'center' },
  signedBadge: { backgroundColor: Colors.mint, borderWidth: 1, borderColor: '#A7F3D0', borderRadius: 12, paddingHorizontal: 8, paddingVertical: 4 },
  ...
  signBtnText: { fontSize: 12, color: Colors.blue, fontWeight: '500' },
